...
<p align="center" style="font-weight : bold; font-size: 20px ; ">  常用中成葯</p>
...
<td><a href='herb_item.php?nm=<?php echo $row["id"]; ?> ' > <?php echo $row["name"]; ?> </a> </td></tr>
